...
slide_buttons("/slides/sesion5/05-01-intro-anal-biv")
```

```{r}
#| echo: false
#| out.width: 100%
knitr::include_url('../slides/sesion5/05-01-intro-anal-biv.html')
```

### Comparación de grupos: Desenlace numérico

```{r show-slide-tabs2, echo=FALSE, results="asis"}
slide_buttons("/slides/sesion5/05-02-comp-num-grupos")
```

```{r}
#| echo: false
#| out.width: 100%
knitr::include_url('../slides/sesion5/05-02-comp-num-grupos.html')
```

### Comparación de grupos: Desenlace categórico

```{r show-slide-tabs3, echo=FALSE, results="asis"}
slide_buttons("/slides/sesion5/05-03-comp-cat-grupos")
```

```{r}
#| echo: false
#| out.width: 100%
knitr::include_url('../slides/sesion5/05-03-comp-cat-grupos.html')
```

### Comparación de grupos: Desenlace tiempo de supervivencia

```{r show-slide-tabs4, echo=FALSE, results="asis"}
slide_buttons("/slides/sesion5/05-04-comp-superv-grupos")
```

```{r}
#| echo: false
#| out.width: 100%
knitr::include_url('../slides/sesion5/05-04-comp-superv-grupos.html')
```

### Correlación de variables numéricas

```{r show-slide-tabs5, echo=FALSE, results="asis"}
slide_buttons("/slides/sesion5/05-05-corelac-numeric")
```

```{r}
#| echo: false
#| out.width: 100%
knitr::include_url('../slides/sesion5/05-05-corelac-numeric.html')
```
