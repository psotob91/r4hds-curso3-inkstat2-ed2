...
```{r}
preclin_data %>% 
  _____(____, .keep_all = ___) -> preclin_data2
```
...
### b) Muestre qué ratones tienen niveles de úrea mayores a 60 pero niveles de glucosa entre 100 y 160
